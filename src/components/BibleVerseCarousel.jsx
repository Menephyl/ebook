...
export function BibleVerseCarousel() {
  ...
  return (
    <div className="relative bg-gradient-to-r from-amber-800/90 to-amber-900/90 backdrop-blur-sm rounded-lg p-6 md:p-8 shadow-lg border border-amber-700/50">
        ...
        >
          {bibleVerses.map((verse, index) => (
            <div key={index} className="min-w-full px-4">
              <p className="text-white text-lg md:text-xl font-serif italic text-center mb-4 leading-relaxed">
                "{verse.text}"
              </p>
